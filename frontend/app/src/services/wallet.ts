/**
 * Wallet utilities for Anvil local dev and MetaMask.
 *
 * In local dev, we use Anvil's pre-funded accounts directly
 * (no MetaMask needed). In production, this would connect to MetaMask.
 */

import { ethers } from 'ethers';

// Anvil's default pre-funded accounts (from `anvil` output)
export const ANVIL_ACCOUNTS = [
  ...
  { address: '0x976EA74026E726554dB657fA54763abd0C3a0aa9', privateKey: '0x92db14e403b83dfe3df233f83dfa3ecda7b66d68f1cec1437959a01543b18e02' },
  { address: '0x14dC79964da2C08dA15Fb5315796E8155665011E', privateKey: '0x4bbbf85ce3377467afe5d46f804f221813b2bb87f24d81f60f1fcdbf7cbf4356' },
...
/** Sign a message string using an ethers Wallet. */
